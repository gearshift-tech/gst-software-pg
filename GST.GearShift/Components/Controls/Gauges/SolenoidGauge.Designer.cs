namespace GST.Gearshift.Components.Controls.Gauges
{
  partial class SolenoidGauge
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.driveTrackbar = new Soko.Common.Controls.NiceTrackBar();
      ...
      this.currentGaugeBar = new GST.Gearshift.Components.Controls.Gauges.GaugeBar();
      ...
      this.driveTrackbar.BorderStyle = Soko.Common.Controls.NiceBorderStyle.Solid;
      ...
      this.driveTrackbar.ValueChanged += new Soko.Common.Controls.ValueChangedHandler(this.driveTrackbar_ValueChanged);
      // 
      // currentCaptionLabel
      // 
      ...
      this.driveValueLabel.Location = new System.Drawing.Point(82, 310);
      this.driveValueLabel.Name = "driveValueLabel";
      this.driveValueLabel.Size = new System.Drawing.Size(55, 25);
      this.driveValueLabel.TabIndex = 11;
      this.driveValueLabel.Text = "0.0%";
    ...
    private Soko.Common.Controls.NiceTrackBar driveTrackbar;
