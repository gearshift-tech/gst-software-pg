...
namespace Soko.Common.Controls
{
  ...
  public partial class JustPlainBarGauge : UserControl
  {
    ...
    private double _MaxValue = 100;
        ...
        private bool _DrawTextValue = true;

    #endregion Private fields

    #region Constructors & finalizer

    public JustPlainBarGauge()
    {
      InitializeComponent();
    ...
    public double MaxValue
    {
      ...
      set
      {
        ...
        public bool DrawTextValue
        {
            get { return _DrawTextValue; }
            set
            {
                _DrawTextValue = value;
                Invalidate();
            }
        }
        ...
        protected void OnPaint( object sender, PaintEventArgs e )
    {
      ...
      RectangleF barRect = mainRect;
      float normalisedValue = Math.Abs( (float)(this.Value / this.MaxValue) );
