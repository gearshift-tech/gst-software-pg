...
namespace Soko.Common.Controls
{
	...
	[ToolboxBitmap(typeof(NiceTrackBar),"Editors.NiceTrackBar.NiceTrackBar.bmp")]
	[Designer(typeof(NiceTrackBarDesigner))]
	[DefaultProperty("Maximum")]
	[DefaultEvent("ValueChanged")]	
	public class NiceTrackBar : System.Windows.Forms.Control
	{	
		...
		private NiceBorderStyle _borderStyle = NiceBorderStyle.None;
		...
		public NiceTrackBar()
		{
			...
			_borderStyle = NiceBorderStyle.None;
		...
		/// </summary>
		/// <value>A <see cref="NiceBorderStyle"/> that represents the border type of the trackbar control. 
		/// The default is <b>NiceBorderStyle.None</b>.</value>
		[Description("Gets or sets the border type of the trackbar control.")]
		[Category("Appearance"), DefaultValue(typeof(NiceBorderStyle), "None")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		public NiceBorderStyle BorderStyle 
		{
			get 
			{
				return _borderStyle;
    ...
    /// <summary>
    /// Sets a numeric value that represents the current position of the slider on the track bar. No 'value changed' event triggered
    /// </summary>
    public void SetValueWithoutEvent(int value)
    {
      ...
      ValueChanged?.Invoke(this, value);
		...
		public virtual void OnScroll()
		{
			...
			{
        // Any attached event handlers?
        Scroll?.Invoke(this, new System.EventArgs());
      }
			catch(Exception Err)
			{
		...
		{
			DrawNiceStyleHelper.DrawAquaPillSingleLayer(g, drawRect,_trackLineColor,_orientation);
		}
		...
		{
			DrawNiceStyleHelper.DrawAquaPill(g, trackerRect,_trackerColor,_orientation);
		}
