...
{
	/// <summary>
  /// The Designer for the <see cref="NiceTrackBar"/>.
	/// </summary>
	public class NiceTrackBarDesigner : System.Windows.Forms.Design.ControlDesigner
	{
    public NiceTrackBarDesigner()
		{}
		...
		{ 
			...
			get 
			{ 
				NiceTrackBar control = this.Control as NiceTrackBar;
    ...
    /// not supported by the <see cref="NiceTrackBar"/>.
		/// </summary>
