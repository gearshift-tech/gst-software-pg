...
namespace LibUsbDotNet.LibUsb
{
    ...
    public class LibUsbDevice : UsbDevice, IUsbDevice
    {
      ...
      {
        RequestType = (byte)UsbEndpointDirection.EndpointOut | (byte)UsbRequestType.TypeStandard | (byte)UsbRequestRecipient.RecipDevice,
        Request = (byte)UsbStandardRequest.SetConfiguration,
        Value = config,
        Index = 0,
        Length = 0
      };
