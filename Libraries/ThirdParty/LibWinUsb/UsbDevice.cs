...
namespace LibUsbDotNet
{
    ...
    public abstract partial class UsbDevice
    {
      ...
      {
        RequestType = (byte)UsbEndpointDirection.EndpointIn | (byte)UsbRequestType.TypeStandard |
                             (byte)UsbRequestRecipient.RecipDevice,
        Request = (byte)UsbStandardRequest.GetConfiguration,
        Value = 0,
        Index = 0,
        Length = 1
      };
      ...
      UsbSetupPacket setupPkt = new UsbSetupPacket
      {
        ...
        Request = (byte)UsbStandardRequest.GetInterface,
        Value = 0,
        Index = interfaceID,
        Length = 1
      };
