	...
	#region ContextMenu
		...
		private void contextMenuStrip1_Opening( object sender, CancelEventArgs e )
		{
          ...
          ToolStripMenuItem item = new ToolStripMenuItem
          {
            Name = "copy",
            Tag = "copy",
            Text = _resourceManager.GetString("copy")
          };
          ...
          item = new ToolStripMenuItem
          {
            Name = "save_as",
            Tag = "save_as",
            Text = _resourceManager.GetString("save_as")
          };
          ...
          item = new ToolStripMenuItem
          {
            Name = "page_setup",
            Tag = "page_setup",
            Text = _resourceManager.GetString("page_setup")
          };
          ...
          item = new ToolStripMenuItem
          {
            Name = "print",
            Tag = "print",
            Text = _resourceManager.GetString("print")
          };
          ...
          item = new ToolStripMenuItem
          {
            Name = "show_val",
            Tag = "show_val",
            Text = _resourceManager.GetString("show_val")
          };
          ...
          this.ContextMenuBuilder?.Invoke(this, menuStrip, _menuClickPt, objState);
        }
			}
		}
		...
		public void RestoreScale( GraphPane primaryPane )
		{
          ...
          this.ZoomEvent?.Invoke(this, oldState, new ZoomState(primaryPane, ZoomState.StateType.Zoom));
		...
		*/
        ...
        // Provide Callback to notify the user of zoom events
        this.ZoomEvent?.Invoke(this, oldState, newState);
